...
public class MoveBackAndForth : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach(GameObject object1 in ObjectsToMove)
        {
            startPositions.Add(object1.transform.position); // one of these lists needs this kind of position...
            endPositions.Add(object1.transform.position + new Vector3(0,0,10f)); // another one needs another...
        }
    }
